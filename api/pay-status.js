...
// cari folder autoft-qris di node_modules (sama kaya di bot WA)
...
module.exports = async (req, res) => {
  ...
  try {
    // persis kayak di bot: new PaymentChecker({ auth_token, auth_username })
    ...
    // biasanya berbentuk { success, data, message, ... }
